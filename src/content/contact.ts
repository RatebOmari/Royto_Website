...
export const contactIntents: Record<ContactIntent, IntentCopy> = {
  ...
  founding: {
    ...
    lede: "Tell me what’s eating your week, and where in North Carolina you are. The first two or three founding clients get a free audit, a discounted build, and my full attention — in exchange for permission to write up what we did.",
    prompt: "What’s eating your week?",
