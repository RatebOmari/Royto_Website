...
export const hero = {
  eyebrow: "Royto — an AI agency for businesses that would rather not do the admin",
...
export const foundingBar = {
  ...
  body: "The first two or three businesses get a free audit, the build at 25% off the scoped price, and my full attention — in exchange for permission to write up what we did.",
