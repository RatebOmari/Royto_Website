...
| Lighthouse `/` mobile | Perf 93–95 across three runs · A11y 100 · Best Practices 100 · SEO 100 (12 Sep 2026, after the navigation pass). The LCP element is the nav wordmark with a ~2.6 s simulated render delay — the framework floor below, not page content — so the score moves with run-to-run noise rather than with what is on the page. |
